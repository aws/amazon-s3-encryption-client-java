...
public abstract class ContentMetadataStrategyAsync implements ContentMetadataEncodingStrategy, ContentMetadataDecodingStrategyAsync {

    private static final Base64.Encoder ENCODER = Base64.getEncoder();
    private static final Base64.Decoder DECODER = Base64.getDecoder();

    public static final ContentMetadataDecodingStrategyAsync INSTRUCTION_FILE = new ContentMetadataDecodingStrategyAsync() {

        private static final String FILE_SUFFIX = ".instruction";

        @Override
        public ContentMetadata decodeMetadata(S3AsyncClient client, GetObjectRequest getObjectRequest, GetObjectResponse response) throws ExecutionException, InterruptedException {
            ...
            return ContentMetadataStrategyAsync.readFromMap(metadata);
        }
    };

    public static final ContentMetadataStrategyAsync OBJECT_METADATA = new ContentMetadataStrategyAsync() {
        ...
        @Override
        public ContentMetadata decodeMetadata(S3AsyncClient client, GetObjectRequest request, GetObjectResponse response) {
            return ContentMetadataStrategyAsync.readFromMap(response.metadata());
        }
    };
    ...
    public static ContentMetadata decode(S3AsyncClient client, GetObjectRequest request, GetObjectResponse response) throws ExecutionException, InterruptedException {
        Map<String, String> metadata = response.metadata();
        ContentMetadataDecodingStrategyAsync strategy;
        if (metadata != null
