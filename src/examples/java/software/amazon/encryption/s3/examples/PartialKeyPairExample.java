...
public class PartialKeyPairExample {
    ...
    private static final String PUBLIC_AND_PRIVATE_KEY_OBJECT_KEY = generateObjectKey(10);
    private static final String PUBLIC_KEY_OBJECT_KEY = generateObjectKey(10);
    private static final String PRIVATE_KEY_OBJECT_KEY = generateObjectKey(10);
