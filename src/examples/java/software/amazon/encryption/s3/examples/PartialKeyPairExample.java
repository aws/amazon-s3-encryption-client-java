...
public class PartialKeyPairExample {
    private static final String BUCKET = "NameOfYourS3Bucket";
    ...
    public static void main(final String[] args) throws NoSuchAlgorithmException {
        ...
        useBothPublicAndPrivateKey();
        useOnlyPublicKey();
        useOnlyPrivateKey();
    }

    static void useBothPublicAndPrivateKey() {
        ...
        assert output.equals(OBJECT_CONTENT);
    }

    static void useOnlyPublicKey() {
        // 1. Instantiate the S3 Encryption Client using its builder.
